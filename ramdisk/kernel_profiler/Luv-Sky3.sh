...
# Description=Luuvy Kernel profile optimized for a performance experience. 
## Author: zeta96
# Luuvy Kernel
#

if [ "$(grep -c Luuvy-Sky /proc/version)" -eq "1" ]; then 
	echo "Apply Luv-Sky3 profile..."  | tee /dev/kmsg &>/dev/null
	...
	echo '375' > /sys/class/kgsl/kgsl-3d0/min_clock_mhz
	...
	echo '18432,23040,27648,51200,150272,200448' > /sys/module/lowmemorykiller/parameters/minfree
